    ...
    def evaluate(
        ...
        for cur_iter, (imgs, _, info_imgs, ids) in enumerate(
            ...
            with torch.no_grad():
                ...
                # 실제 Scene마다 Theshold를 다르게 주고 있습니다. 만약 여러분이 여러개의 scene을 사용한다면 각 Scene마다 적합한 Threshold를 줄 수 있습니다.
                ...
                #img는 이미 정규화 되어있을 겁니다. 정규화 방식은 전처리 파트의 코드를 참고하면 되는데 아마 사용하셨던 방식이랑 동일할 겁니다.
            ...
            # run tracking, Tracking을 시작하는 부분입니다. 
            if outputs[0] is not None:
                ...
                for t in online_targets:
                    tlwh = t.tlwh # Track의 x,y,w,h
                    tid = t.track_id # Track의 id
